package Com.Scanner.QrBarcode.details;
...
import Com.Scanner.QrBarcode.main.HomeActivity;
import butterknife.BindView;
import butterknife.ButterKnife;
import Com.Scanner.QrBarcode.R;
import Com.Scanner.QrBarcode.model.Scan;
import Com.Scanner.QrBarcode.util.Utils;
import Com.Scanner.QrBarcode.viewmodel.ScanViewModel;
import Com.Scanner.QrBarcode.zxingadditional.result.ActionAdapter;
import Com.Scanner.QrBarcode.create.QRCode;
import Com.Scanner.QrBarcode.zxingadditional.result.ResultHandler;
import Com.Scanner.QrBarcode.zxingadditional.result.ResultHandlerFactory;

import static Com.Scanner.QrBarcode.main.MainActivity.ADD_TO_CLIP;
import static Com.Scanner.QrBarcode.main.MainActivity.ADD_TO_HISTORY;
import static Com.Scanner.QrBarcode.main.MainActivity.QR_STRING;
import static Com.Scanner.QrBarcode.main.MainActivity.QR_TYPE;
import static Com.Scanner.QrBarcode.util.Utils.isStoragePermissionGranted;
...
//        super.onBackPressed();
        Intent intenti = new Intent(DetailsActivity.this, HomeActivity.class);
        intenti.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TASK|Intent.FLAG_ACTIVITY_NEW_TASK);
