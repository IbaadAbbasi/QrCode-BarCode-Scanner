...
import Com.Scanner.QrBarcode.create.schemes.VCard;
...
public class ContactInputFragment extends AppCompatActivity {
...
/* @Override
    ...
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.fragment_contact_input);
...
//       final View view =  inflater.inflate(R.layout.fragment_contact_input, container, false);
       EditText  nameTv =  findViewById(R.id.name_input);
       EditText  orgTv  =  findViewById(R.id.organization_input);
       EditText  tittleTv =    findViewById(R.id.tittle_input);
       EditText phoneTv   =    findViewById(R.id.phone_input);
       EditText websiteTv =    findViewById(R.id.website_input);
       EditText emailTv    =   findViewById(R.id.email_input);
       EditText addressTv   =  findViewById(R.id.address_input);
